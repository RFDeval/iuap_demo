...
//定义接口地址
const URL = {
    "GET_DETAIL":  `${GROBAL_HTTP_CTX}/demo_order/list`,
    "SAVE_ORDER":  `${GROBAL_HTTP_CTX}/demo_order/save`,
    "GET_LIST":  `${GROBAL_HTTP_CTX}/demo_order/list`,    
    "DEL_ORDER":  `${GROBAL_HTTP_CTX}/demo_order/deleteBatch`,
    // 打印
...
export const saveDemoOrder = (params) => {
    return request(URL.SAVE_ORDER, {
        method: "post",
        data: params
    });
}
export const delDemoOrder = (params) => {
